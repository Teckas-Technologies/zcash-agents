...
import { prepareSwapSignedData } from "../../utils/prepareSignedData"
...
export type PublishIntentResult =
    ...
    | {
        tag: "err"
        value: { reason: any } //  types.PublishIntentResponseFailure["reason"]
    }
...
export async function publishIntent(
    ...
    console.log("quoteHashes", quoteHashes)
    ...
    return { tag: "err", value: { reason: result.reason } }
}
