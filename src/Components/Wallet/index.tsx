...
import { isSupportedByBrowser } from "@/features/webauthn/lib/webauthnService"
...
import { mapStringToEmojis } from "@/utils/emoji"
import { TURN_OFF_APPS } from "@/utils/environment"
        ...
        return (
            <Popover.Root open={isOpen} onOpenChange={setIsOpen}>
                ...
                <Popover.Content
                    ...
                    className="md:mr-[48px] dark:bg-black-800 rounded-2xl max-h-[23.5rem] overflow-y-scroll scroll-d"
                >
                        ...
                        {isSupportedByBrowser() && (
                            ...
                            >
                                <div className="w-full flex items-center justify-start gap-2">
                                    <Image
                                        src="/icons/wallets/webauthn.svg"
                                        alt=""
                                        width={36}
                                        height={36}
                                    />
                        ...
                        {whitelabelTemplate === "turboswap" ? (
                            <>
                                ...
                                >
                                    <div className="w-full flex items-center justify-start gap-2">
                                        <Image
                                            src="/icons/wallets/near-wallet-selector.svg"
                                ...
                                >
                                    <div className="w-full flex items-center justify-start gap-2">
                                        <Image
                                            src="/icons/wallets/solana-logo-mark.svg"
...
function WalletIcon({ connector }: { connector: Connector }) {
    switch (connector.id) {
        case "walletConnect":
            return (
                <Image
                    src="/icons/wallets/wallet-connect.svg"
                    alt="Wallet Connect"
                    width={36}
                    height={36}
                />
        ...
        case "coinbaseWalletSDK":
            return (
                <Image
                    src="/icons/wallets/coinbase-wallet.svg"
                    alt="Coinbase Wallet"
                    width={36}
                    height={36}
                />
        ...
        case "metaMaskSDK":
            return (
                <Image
                    src="/icons/wallets/meta-mask.svg"
                    alt="MetaMask"
                    width={36}
                    height={36}
                />
