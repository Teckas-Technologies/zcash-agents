...
export const DEV_MODE = process?.env?.NEXT_PUBLIC_DEV_MODE === "true" ? true : false // ?? false // TODO
export const TURN_OFF_APPS = process?.env?.turnOffApps === "true" ? true : true // ?? true
